...
const Header = () => {
  ...
  return (
    <header className="fixed shadow-md w-full h-16 px-2 md:px-4 z-50 bg-raising-black">
      {/* desktop */}
      ...
      <div className="flex items-center h-full justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-7">
          <nav className="gap-4 md:gap-6 text-base md:text-lg hidden md:flex">
            ...
            <Link to={"menu"} className="text-gold">
              Menu
            </Link>
          ...
          <div className="text-2xl text-slate-100 relative">
            <Link to={"cart"}>
              <BsCartFill />
              <div className="absolute -top-1 -right-1 text-white bg-blue-500 h-4 w-4 rounded-full m-0 p-0 text-sm text-center ">
